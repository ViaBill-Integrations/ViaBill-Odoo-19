...
"""
Migration 19.0.1.0.0 — Add all ViaBill-specific columns to payment_provider.

This covers upgrades from any version prior to 19.0.1.0.0.
"""
import logging
...
def migrate(cr, version):
    _add_column_if_missing(cr, 'viabill_api_key',            'VARCHAR',  'NULL')
    _add_column_if_missing(cr, 'viabill_secret_key',         'VARCHAR',  'NULL')
    _add_column_if_missing(cr, 'viabill_pricetag_script',    'TEXT',     'NULL')
    ...
    _logger.info("ViaBill migration 19.0.1.0.0 complete.")
