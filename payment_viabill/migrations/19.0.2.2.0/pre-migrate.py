...
"""
Migration 19.0.2.2.0 — Ensure all ViaBill columns exist (idempotent catch-all).

This covers upgrades from 19.0.2.1.0 where the migration may not have run
because the database version record was not updated correctly.
"""
import logging
...
def migrate(cr, version):
    ...
    _logger.info("ViaBill migration 19.0.2.2.0 complete.")
